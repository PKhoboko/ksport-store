        ...
        <div className="min-h-screen bg-zinc-50">
            <div className="bg-white border-b border-zinc-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-8 py-8 sm:py-14">
                    <p className="text-[8px] sm:text-[10px] font-black tracking-[0.4em] text-zinc-400 uppercase mb-2">Zikiano</p>
                    <h1 className="text-4xl sm:text-7xl font-black italic tracking-tighter text-zinc-900 leading-none">The Shop</h1>
                    <p className="text-[10px] sm:text-xs text-zinc-400 font-medium mt-3">
                        {groups.length} models &nbsp;·&nbsp; {totalColourways} colourways
                    </p>
                </div>
            </div>

            <div className="max-w-7xl mx-auto px-3 sm:px-6 py-8 sm:py-14">
                {groups.length === 0 ? (
